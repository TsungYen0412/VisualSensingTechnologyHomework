...
class Interface(object):
    ...
    def __init__(self):
        Interface.Obj_Num += 1
        print("Create 1 obj: Total number of Interface objects is "+ str(Interface.Obj_Num))
        ...
        self.fileExtensionToPng("img/dst/src.png", self.srcImage)
        self.loadSrcImage = tk.PhotoImage(file="img/dst/src.png")
        ...
        self.fileExtensionToPng("img/dst/dst.png", self.dstImage)
        self.loadDstImage = tk.PhotoImage(file="img/dst/dst.png")
    ...
    def __del__(self):
        Interface.Obj_Num -= 1
        print("Delete 1 obj: Total number of Interface objects is "+ str(Interface.Obj_Num))
        del self.IP
    ...
    def readCommand(self):
        ...
        if self.srcImage.shape[2] == 4:
            ...
            self.srcBGR = np.array(self.srcImage)
        self.fileExtensionToPng("img/dst/src.png", self.srcBGR)
        self.loadSrcImage = tk.PhotoImage(file="img/dst/src.png")
    ...
    def createSmoothValueFrame(self):
        ...
        if self.smoothButtonValue != self.IP.SmoothType.BILATERAL:
            ...
            self.smoothKsizeValueScale.set("3")
        else:
    ...
    def smoothKsizeValueCommand(self, number = 3):
    ...
    def createSharpeningValueFrame(self):
        ...
        self.sharpeningLandaValueScale = tk.Scale(self.sharpeningValueFrame, orient=tk.HORIZONTAL, from_=0, to=1, resolution=0.1,
                                                   length=200, command=self.sharpeningLandaValueCommand)
        self.sharpeningLandaValueScale.pack(side=tk.LEFT)
        self.sharpeningLandaValueScale.set("0.5")

    def sharpeningLandaValueCommand(self, number = 0.5):
